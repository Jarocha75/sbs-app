...
export default function KurzSPage() {
...
function PredmetCard({
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm py-4 flex items-start gap-4" style={{ paddingLeft: '2.5rem', paddingRight: '2.5rem' }}>
      <span
