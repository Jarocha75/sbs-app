...
import { ustavaContent, questions, type Answer } from '@/data/test-ustava-sr'
...
export default function UstavaSrPage() {
  const { hero, backHref, backLabel, result } = ustavaContent
