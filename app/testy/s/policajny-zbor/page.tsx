...
import { policajnyZborContent, questions, type Answer } from '@/data/test-policajny-zbor'
import { useShuffledQuestions } from '@/hooks/useShuffledQuestions'
import { NavButton, type Phase } from '@/app/components/NavButton'

export default function PolicajnyZborPage() {
  const { hero, backHref, backLabel, result } = policajnyZborContent
