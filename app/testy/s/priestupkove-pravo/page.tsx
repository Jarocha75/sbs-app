...
import { priestupkyContent, questions, type Answer } from '@/data/test-priestupkove-pravo'
import { useShuffledQuestions } from '@/hooks/useShuffledQuestions'
import { NavButton, type Phase } from '@/app/components/NavButton'

export default function PriestupkovePravoPage() {
  const { hero, backHref, backLabel, result } = priestupkyContent
