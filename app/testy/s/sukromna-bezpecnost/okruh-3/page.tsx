...
import { okruh3Content, questions, type Answer } from '@/data/test-sukromna-bezpecnost-okruh-3'
...
export default function Okruh3Page() {
  const { hero, backHref, backLabel, result } = okruh3Content
