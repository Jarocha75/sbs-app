...
import { okruh4Content, questions, type Answer } from '@/data/test-sukromna-bezpecnost-okruh-4'
...
export default function Okruh4Page() {
  const { hero, backHref, backLabel, result } = okruh4Content
