...
import { kriminalistikaContent, questions, type Answer } from '@/data/test-kriminalistika'
...
export default function KriminalistikaPage() {
  const { hero, backHref, backLabel, result } = kriminalistikaContent
